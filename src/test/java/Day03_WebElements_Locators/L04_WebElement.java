...
public class L04_WebElement {
    public static void main(String[] args) throws InterruptedException {
        ...
        // Position after maximizing: (0, 38)
        System.out.println("Size after maximizing: " + driver.manage().window().getSize());
        // Size after maximizing: (1728, 1079)

        Thread.sleep(3000);

        driver.manage().window().fullscreen();
        System.out.println("Position in full screen mode: " + driver.manage().window().getPosition());
        // Position in full screen mode: (0, 37)
        System.out.println("Size in full screen mode: " + driver.manage().window().getSize());
        // Size in full screen mode: (1728, 1080)
